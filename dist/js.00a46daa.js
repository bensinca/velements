...
},{"gsap":"TpQl","./utils":"8MgT"}],"EFc8":[function(require,module,exports) {
"use strict";
...
var ContentPage = function ContentPage(el) {
  ...
  this.DOM.textInner = this.DOM.text.querySelector("span");
  ...
  _createClass(MenuController, [{
    ...
    value: function showContent(menuItem) {
      ...
      _gsap.gsap.timeline({
        ...
        y: "100%"
      }, 0).addLabel("showPageContent", timelineDefaults.duration * 0.1).to(menuItem.contentPage.DOM.backCtrl, {
        startAt: {
          x: "50%"
        },
        x: "0%",
        opacity: 1
      }, "showPageContent").to([menuItem.contentPage.DOM.titleInner, menuItem.contentPage.DOM.introInner, menuItem.contentPage.DOM.textInner, menuItem.contentPage.DOM.dateInner], {
        startAt: {
          y: "-100%"
        },
        onStart: function onStart() {
          _gsap.gsap.set([menuItem.contentPage.DOM.title, menuItem.contentPage.DOM.intro, menuItem.contentPage.DOM.text, menuItem.contentPage.DOM.date], {
            opacity: 1,
            stagger: -0.06
          });
        },
    ...
    value: function showMenu(menuItem) {
      ...
      var menuOffset = document.getElementById("menu").offsetTop - 100; // Scroll up first

      (0, _utils.scrollIt)(menuOffset, 300, "easeOutQuad", function () {
        _gsap.gsap.timeline({
          defaults: timelineDefaults,
          onStart: function onStart() {
          ...
          opacity: 0,
          stagger: 0.08
        }, 0).to([menuItem.contentPage.DOM.titleInner, menuItem.contentPage.DOM.introInner, menuItem.contentPage.DOM.textInner, menuItem.contentPage.DOM.dateInner], {
          onComplete: function onComplete() {
            _gsap.gsap.set([menuItem.contentPage.DOM.title, menuItem.contentPage.DOM.intro, menuItem.contentPage.DOM.text, menuItem.contentPage.DOM.date], {
              opacity: 0
            });
          ...
          x: "50%",
          opacity: 0
        }, 0).addLabel("showMenuItems", timelineDefaults.duration * 0.1).to(_this5.DOM.headline.text, {
          y: "0%"
...
},{"./utils":"8MgT","gsap":"TpQl","./menuItem":"Jy3L"}],"QvaY":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _utils.preloadImages)(".gallery__figure-img"), (0, _utils.preloadFonts)("yuz0mhb")]).then(function () {
  ...
  _toConsumableArray(document.querySelectorAll("a, h2")).forEach(function (link) {
...
},{"./utils":"8MgT","./cursor":"+9LM","./menuController":"tn5Z"}]},{},["QvaY"], null)